...
fourDRCalc_zeroSum<-function(rank_table,game_max){
...
updateFx<-function(){
  ...
  ## Run 4DR calculation
  fourDR_returns<-fourDRCalc_zeroSum(rank_table,game_max) #updated - zero sum version; simultaneous game calcs (not sequential for the 4 players); div by 3
